...
// BT: I'm modifying this type definition to remove the globally defined
// "_" var. This forces users of lodash to import it properly on each file.
...
declare module _ {
    ...
    **/
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<TResult>(): LoDashArrayWrapper<TResult>;

        /**
         * @see _.flatten
         **/
        flatten<TResult>(isShallow: boolean): LoDashArrayWrapper<TResult>;
    }
    ...
    interface LoDashStatic {
        ...
        **/
        assign<T>(
            object: T,
            s1: T,
            callback?: (objectValue: T, sourceValue: T) => T,
            thisArg?: any): T;
    ...
    interface LoDashStatic {
         ...
         */
        runInContext(context?: Object): _.LoDashStatic;
    }
    ...
    // lodash-fix:
    //
    // The following definitions are written by our team as fixes to the original .d.ts file
    // above. If we ever update this .d.ts file, these definitions should be copied over.
    // ======================================================================================= //
    ...
    interface LoDashStatic {
        ...
        * @see _.values
        **/
        values<T>(object?: { [key: number]: T }): T[];
    }
    ...
    interface LoDashStatic {
        ...
        * @see _.assign
        **/
        assign<P, T, S1, S2, S3, S4, S5, Value, Result>(
            object: T,
            s1: S1,
            s2: S2,
            s3: S3,
        ...
        * @see _.assign
        **/
        extend<P, T, S1, S2, S3, S4, S5, Value, Result>(
            object: T,
            s1: S1,
            s2: S2,
            s3: S3,
        ...
        * @see _.assign
        **/
        assign<P, T, S1, S2, S3, S4, S5, S6, Value, Result>(
            object: T,
            s1: S1,
            s2: S2,
            s3: S3,
        ...
        * @see _.assign
        **/
        extend<P, T, S1, S2, S3, S4, S5, S6, Value, Result>(
            object: T,
            s1: S1,
            s2: S2,
            s3: S3,
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.first
         */
        first<TResult>(): LoDashWrapper<TResult>;
    }
    ...
    interface LoDashArrayWrapper<T> {
       ...
       **/
        ...
        **/
        reduce<TResult>(
            callback: MemoIterator<T, T | TResult>,
            thisArg?: any): LoDashObjectWrapper<T | TResult>;
    ...
    interface LoDashObjectWrapper<T> {
       ...
       **/
        ...
        **/
        reduce<TValue, TResult>(
            callback: MemoIterator<TValue, TValue | TResult>,
            thisArg?: any): LoDashObjectWrapper<TValue | TResult>;
    ...
    interface LoDashArrayWrapper<T> {
        ...
        **/
        indexBy(
            iterator: ListIterator<T, number|string>,
            context?: any): LoDashObjectWrapper<_.Dictionary<T>>;
        ...
        **/
        indexBy(
            pluckValue: string): LoDashObjectWrapper<_.Dictionary<T>>;
        ...
        **/
        indexBy<W>(
            whereValue: W): LoDashObjectWrapper<_.Dictionary<T>>;
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.isArguments
         */
        isArguments(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.isBoolean
         */
        isBoolean(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.isElement
         */
        isElement(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashStatic {
         ...
         * @return Returns true if value is an error object, else false.
         */
        isError(value: any): value is Error|EvalError|RangeError|ReferenceError|SyntaxError|TypeError|URIError;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.isFinite
         */
        isFinite(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * @see _.isFunction
         */
        isFunction(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * see _.isNumber
         */
        isNumber(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * see _.isObject
         */
        isObject(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * see _.isRegExp
         */
        isRegExp(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashWrapperBase<T, TWrapper> {
         ...
         * see _.isString
         */
        isString(): LoDashWrapper<boolean>;
    }
    ...
    interface LoDashStatic {
        ...
        **/
        ...
        sortByAll<T>(
            collection: Dictionary<T>,
            ...args: (DictionaryIterator<T, boolean> | Object | string)[]
        ): T[];
    }
